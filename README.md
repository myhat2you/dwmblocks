...
| Script        | Display            | Left Click               | Right Click       |
|---------------|--------------------|--------------------------|-------------------|
| `sb-clock`    | Date and time       | Opens calendar           | N/A               |
| `sb-music`    | MPD song title      | N/A                      | N/A               |
| `sb-volume`   | System volume       | N/A                      | N/A               |
| `sb-record`   | Recording icon      | N/A                      | N/A               |
| `sb-memory`   | RAM usage           | Lists programs using RAM | N/A               |
| `sb-cpu`      | CPU usage           | Lists programs using CPU  | N/A               |
| `sb-disk`     | Disk usage          | Lists drives & partitions| N/A               |
| `sb-news`     | Number of new articles | Opens Newsboat          | Syncs Newsboat    |
| `sb-mailbox`  | Number of new emails  | Opens Neomutt           | Syncs mail        |
| `sb-updates`  | Number of updates   | Lists packages           | Syncs updates     |
| `sb-internet` | Local IP address    | Shows network info       | N/A               |
| `sb-battery`  | Battery percentage  | N/A                      | N/A               |
